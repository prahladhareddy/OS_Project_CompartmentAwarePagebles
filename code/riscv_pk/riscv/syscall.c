...
uintptr_t sys_mmap(uintptr_t addr, size_t length, int prot, int flags, int fd, off_t offset)
{
  ...
  offset <<= 12;
#endif
  return do_mmap(addr, length, prot, flags, fd, offset,DEF_CID);
}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
char* sys_my_alloc(int a)
{
	return (char *) do_my_alloc(a);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
