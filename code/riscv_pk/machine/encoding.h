...
#define DEF_CID   0     /* default compartment id */
...
DECLARE_CSR(uret254, CSR_URET254)
DECLARE_CSR(uretnon254, CSR_URETNON254)
DECLARE_CSR(uretcrosscomp, CSR_URETCROSSCOMP)
