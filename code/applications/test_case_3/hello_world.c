...
void main(){
	...
	printf("STARTED TESTING FOR COMPARTMENT 0\n");
	...
	printf("STARTED TESTING FOR COMPARTMENT 1\n");
	...
	printf("STARTED TESTING FOR COMPARTMENT 6\n");
	int* d= (int *) my_alloc(6);
	d[44] = 100;
	d[66] = 110;
	d[11] = d[44] + d[66];
	printf("b[11] = %d\n", d[11]);
	printf("COMPLEATED TESTING FOR COMPARTMENT 6\n");
